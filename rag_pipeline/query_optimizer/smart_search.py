"""
Smart Search System - Production-ready search combining all optimizations
Integrates: HybridSearcher + QueryOptimizer + MetadataFilter
"""
...
from rag_pipeline.hybrid_search.hybrid_search import HybridSearcher
...
if __name__ == "__main__":
    ...
    print("\nTEST 2: FILTERED SEARCH (Q4 only)")
    filtered = searcher.search_filtered("campaigns", top_k=2, quarter="Q4", year=2024)
